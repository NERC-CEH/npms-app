...
function Cover({ sample, occurrence }) {
  ...
  return (
    <div className="occurrence-home-main">
      <div className="table-view-divider">Species photos</div>
      <ImagePicker model={occurrence} />

      <div className="table-view-divider">Species cover</div>
